...
Secara keseluruhan, rasio dosen dan mahasiswa di untirta adalah 1 : `r round(sum(rasio$mahasiswa)/sum(rasio$dosen, na.rm = T), 0)` di mana banyaknya dosen (pns dan non pns) adalah `r sum(rasio$dosen, na.rm = T)` orang dan mahasiswa aktif sebanyak `r sum(as.integer(rasio$mahasiswa))` orang. Rasio dosen dan mahasiswa ideal untuk rumpun sosial adalah 1 : 45 dan untuk rumpun sains adalah 1 : 30. Berikut adalah rasio dosen dan mahasiswa Universitas Sultan Ageng Tirtayasa di setiap Program Studi.
