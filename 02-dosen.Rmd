...
Saat ini Universitas Sultan Ageng Tirtayasa memiliki `r nrow(dos_pns)` dosen tetap PNS dan `r nrow(dos_non)` dosen tetap non PNS yang tersebar di 6 Fakultas. Berikut ini adalah stasitik Dosen tetap PNS dan dosen tetap non PNS di lingkungan Universitas Sultan Ageng Tirtayasa.
